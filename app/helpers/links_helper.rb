module LinksHelper
  def link_to_new_record(name, path, options = {})
    options[:class] = customization_classes_merged_into_default_classes(options[:class] || "", "flex p-1 rounded bg-gray-100 border border-gray-300 hover:bg-amber600 hover:text-white")
  ...
  # TODO: This could be cleaner I think
