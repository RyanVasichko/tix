      ...
      @template.content_tag(:div, options) do
        combobox = @template.content_tag(:div, class: "relative mt-2") do
          ...
          text_field_options = {
            ...
            class: "mt-2 block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-offset focus:ring-amber-500/75 sm:leading-6",
            role: "combobox",
            "aria-expanded": false,
            autocomplete: "off"
          }
